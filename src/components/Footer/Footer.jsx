    ...
    <footer className="bg-gray-950 text-gray-300 py-12 mt-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <Link to="/" className="text-2xl font-bold text-emerald-600 mb-4 md:mb-0">15 Puzzle Game</Link>
          ...
          <div className="text-gray-400">&copy; 2024 15 Puzzle Game. All rights reserved.</div>
        </div>
      </div>
    </footer>
  );
